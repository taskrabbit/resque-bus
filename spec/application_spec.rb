  ...
  describe Application do
    ...
    describe "#read_redis_hash" do
      it "should handle old and new values" do
        ...
        ResqueBus.redis { |redis| redis.hset("resquebus_app:myapp", "new_one", ResqueBus::Util.encode("queue_name" => "x", "bus_event_type" => "event_name") ) }
        ResqueBus.redis { |redis| redis.hset("resquebus_app:myapp", "old_one", "oldqueue_name") }
    ...
    describe "#subscribe" do
      ...
      it "should add array to redis" do
        ResqueBus.redis { |redis| redis.get("resquebus_app:myapp") }.should be_nil
        Application.new("myapp").subscribe(test_list(sub1, sub2))

        ResqueBus.redis { |redis| redis.hgetall("resquebus_app:myapp") }.should == {"event_two"=>"{\"queue_name\":\"default\",\"key\":\"event_two\",\"class\":\"::ResqueBus::Rider\",\"matcher\":{\"bus_event_type\":\"event_two\"}}",
                                                                  "event_one"=>"{\"queue_name\":\"default\",\"key\":\"event_one\",\"class\":\"::ResqueBus::Rider\",\"matcher\":{\"bus_event_type\":\"event_one\"}}"}
        ResqueBus.redis { |redis| redis.hkeys("resquebus_app:myapp") }.should =~ ["event_one", "event_two"]
        ResqueBus.redis { |redis| redis.smembers("resquebus_apps") }.should =~ ["myapp"]
      end
      it "should add string to redis" do
        ResqueBus.redis { |redis| redis.get("resquebus_app:myapp") }.should be_nil
        Application.new("myapp").subscribe(test_list(sub1))

        ResqueBus.redis { |redis| redis.hgetall("resquebus_app:myapp") }.should == {"event_one"=>"{\"queue_name\":\"default\",\"key\":\"event_one\",\"class\":\"::ResqueBus::Rider\",\"matcher\":{\"bus_event_type\":\"event_one\"}}"}
        ResqueBus.redis { |redis| redis.hkeys("resquebus_app:myapp") }.should =~ ["event_one"]
        ResqueBus.redis { |redis| redis.smembers("resquebus_apps") }.should =~ ["myapp"]
      end
      it "should multiple queues to redis" do
        ResqueBus.redis { |redis| redis.get("resquebus_app:myapp") }.should be_nil
        Application.new("myapp").subscribe(test_list(sub1, sub2, sub3))
        ResqueBus.redis { |redis| redis.hgetall("resquebus_app:myapp") }.should == {"event_two"=>"{\"queue_name\":\"default\",\"key\":\"event_two\",\"class\":\"::ResqueBus::Rider\",\"matcher\":{\"bus_event_type\":\"event_two\"}}", "event_one"=>"{\"queue_name\":\"default\",\"key\":\"event_one\",\"class\":\"::ResqueBus::Rider\",\"matcher\":{\"bus_event_type\":\"event_one\"}}",
                                                                  "event_three"=>"{\"queue_name\":\"other\",\"key\":\"event_three\",\"class\":\"::ResqueBus::Rider\",\"matcher\":{\"bus_event_type\":\"event_three\"}}"}
        ResqueBus.redis { |redis| redis.hkeys("resquebus_app:myapp") }.should =~ ["event_three", "event_two", "event_one"]
        ResqueBus.redis { |redis| redis.smembers("resquebus_apps") }.should =~ ["myapp"]
      end
    ...
    describe "#unsubscribe" do
      it "should remove items" do
        ResqueBus.redis { |redis| redis.sadd("resquebus_apps", "myapp") }
        ResqueBus.redis { |redis| redis.sadd("resquebus_apps", "other") }
        ResqueBus.redis { |redis| redis.hset("resquebus_app:myapp", "event_one", "myapp_default") }

        Application.new("myapp").unsubscribe

        ResqueBus.redis { |redis| redis.smembers("resquebus_apps") }.should == ["other"]
        ResqueBus.redis { |redis| redis.get("resquebus_app:myapp") }.should be_nil
      end
    end
